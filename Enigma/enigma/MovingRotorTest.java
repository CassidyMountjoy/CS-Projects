...
public class MovingRotorTest {
    ...
    public void reflectorTest() {
        Permutation perm = new Permutation(
                "(ABCDEFGHIJKLMNOPQRSTUVWXY) (z)", UPPER);
        Rotor reflector = new Reflector("reflector 1", perm);
        assertEquals(0, reflector.convertForward(24));
        assertEquals(false, reflector.rotates());
        assertEquals(false, reflector.atNotch());
    }
