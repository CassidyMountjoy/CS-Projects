...
public class UnitTest {
    ...
    @Test
    public void isUnblockedMove() {
        Board b = new Board();
        makeSmile(b);
        assertEquals(false, b.isUnblockedMove(Square.sq(3, 2),
                Square.sq(3, 8), Square.sq(9, 9)));
        assertEquals(true, b.isUnblockedMove(Square.sq(3, 2),
                Square.sq(3, 5), Square.sq(9, 9)));
        assertEquals(false, b.isUnblockedMove(Square.sq(3, 2),
                Square.sq(7, 6), Square.sq(9, 9)));
        assertEquals(true, b.isUnblockedMove(Square.sq(9, 6),
                Square.sq(7, 4), Square.sq(9, 9)));
        assertEquals(true, b.isUnblockedMove(Square.sq(9, 6),
                Square.sq(6, 3), Square.sq(9, 9)));
        assertEquals(false, b.isUnblockedMove(Square.sq(3, 2),
                Square.sq(1, 1), Square.sq(9, 9)));
    }
